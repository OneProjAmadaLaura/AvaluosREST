 ...
 * Registro
 ****************************************************************************/
app.post('/propietario', verificaToken, (req, res) => {
    try {

        let etiquetaLOG = ruta + '[Usuario: ' + req.usuario.idUsuario + '] METODO: propietario';
 ...
 * Consulta
 ****************************************************************************/
app.get('/consultaPropietario', verificaToken, (req, res) => {
    try {
        let etiquetaLOG = ruta + '[Usuario: ' + req.usuario.idUsuario + '] METODO: consultaPropietario';
        logger.info(etiquetaLOG);
        ...
        if (datoNoValido == '') {
            BdConsultaPropietario(pFolio.trim(), pUsuarioOperacion)
                .then(result => {
...
/***************************************************************************/
/********************   R e g i s t r o   **********************************/
function BdPropietario(pFolio, pNombre, pPaterno, pMaterno, pTipoPersona, pRFC, pCURP,
    ...
    let etiquetaLOG = ruta + '[Usuario: ' + pUsuarioOperacion + '] METODO: BdPropietario ';
    ...
    try {
        ...
        logger.info(etiquetaLOG + 'SELECT * FROM fPropietario (pFolio, pNombre, pPaterno, pMaterno, pTipoPersona, pRFC, pCURP, pTelefonoFijo, pExtTelefono, pTelefonoMovil, pCP, pIdEntidad, pIdMunicipio, pIdAsentamiento, pCalle, pExterior, pInterior, pManzana, pLote, pEdificio, pUsuarioOperacion);');
        let sQuery = `SELECT * FROM fPropietario (${pFolio}, ${pNombre}, ${pPaterno}, ${pMaterno}, ${pTipoPersona}, ${pRFC}, ${pCURP}, ${pTelefonoFijo}, ${pExtTelefono}, ${pTelefonoMovil}, ${pCP}, ${pIdEntidad}, ${pIdMunicipio}, ${pIdAsentamiento}, ${pCalle}, ${pExterior}, ${pInterior}, ${pManzana}, ${pLote}, ${pEdificio}, ${pUsuarioOperacion});`;
        ...
        logger.error(`${ ruta } ERROR: ${ err }`);
        throw (`Se presentó un error en BdPropietario: ${err}`);
    }
}
/**************   C o n s u l t a   ******************************************/
function BdConsultaPropietario(pFolio, pUsuarioOperacion) {
    let etiquetaLOG = `${ ruta } [Usuario: ${ pUsuarioOperacion }] METODO: BdConsultaPropietario `;
    try {
        logger.info(etiquetaLOG);
        const client = new Pool(configD);

        let sQuery = `SELECT * FROM fConsultaPropietario('${pFolio}');`;
        ...
        logger.error(`${ ruta } ERROR: ${ err } `);
        throw (`Se presentó un error en BdConsultaPropietario: ${err}`);
    }
}
